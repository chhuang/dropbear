...
const DATASET_ID = 'Wfg2lK898yb4Qp51N'
...
async function main() {
  ...
  const stats = { found: 0, new: 0, updated: 0, skipped: 0, noPrice: 0 }
  ...
  for (const item of items) {
    ...
    // Get suburb from item.address.suburb
    ...
    if (existing) {
      // Update last_seen_at and potentially price
