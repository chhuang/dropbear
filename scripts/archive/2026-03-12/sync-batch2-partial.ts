...
const datasetId = '4Kx9BRWGErWa2WgDe'

const suburbMap: Record<string, {name: string, postcode: string}> = {
  'eastwood': { name: 'eastwood', postcode: '2122' },
  'roseville': { name: 'roseville', postcode: '2069' },
  'pymble': { name: 'pymble', postcode: '2073' },
